...
function setupModels(sequelize) {
    ...
    // Asociación entre Service y Appointment
    Service.hasMany(Appointment, { as: 'citas', foreignKey: 'servicioId' });
    Appointment.belongsTo(Service, { as: 'servicio', foreignKey: 'servicioId' });

    // Asociación entre User y Appointment
    User.hasMany(Appointment, { as: 'citas', foreignKey: 'usuarioId' });
    Appointment.belongsTo(User, { as: 'usuario', foreignKey: 'usuarioId' });
}
